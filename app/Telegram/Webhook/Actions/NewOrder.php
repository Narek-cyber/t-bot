...
class NewOrder
{
    ...
    public function sendDate()
    {
        ...
        InlineButton::add('17 January', 'NewOrder2', $data, 1);
        InlineButton::add('18 January', 'NewOrder2', $data, 2);
        InlineButton::add('19 January', 'NewOrder2', $data, 3);
        InlineButton::add('20 January', 'NewOrder2', $data, 4);
